...
-(void)DisplayVendors
{
    ...
    {
        NSString   *fetchdata = [NSString stringWithFormat:@"select id, path, type, created_date from ba_tbl_content where vendor_id=%@",dataid[j]];
...
//    NSLog(@"sortedVendorsByDate=%@",sortedVendorsByDate);
    ...
    if (listAndGridIndex==1)
    {
        ...
        for (int i =0; i<totalVendors; i++)
        {
            ...
            imageOnVendorGrid[i] = [[UIImageView alloc]initWithFrame:CGRectMake(10, 23, 218, 193)];
