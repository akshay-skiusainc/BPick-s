...
-(void)DisplayVendors
{
    ...
    if (listAndGridIndex==1)
    {
        ...
        if(TotalData%3==0)
        {
            ...
            noteScroller.contentSize = CGSizeMake(748,237*TotalData/3+150);
        }
        else
        {
            noteScroller.contentSize = CGSizeMake(748,(237*TotalData/3)+200);
        ...
        if(TotalData%4==0)
        {
            ...
            noteScrollerLand.contentSize = CGSizeMake(1006,237*TotalData/4+150);
        }
        else
        {
            noteScrollerLand.contentSize = CGSizeMake(1006,(237*TotalData/4)+200);
    ...
    if (listAndGridIndex==2)
    {
        for (int i =0; i<TotalData; i++)
        {
            ...
            noteDate[i].text = datadateNote[i];
           // noteDate[i].text = @"note date";
